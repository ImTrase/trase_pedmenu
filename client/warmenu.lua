...
local defaultStyle = {
    ...
    bannerImage = 'https://cdn.discordapp.com/attachments/859264314304233502/979278560244162560/Warmenu_Banner.png' -- Change URL here to change banner background.
}


local runtime = CreateRuntimeTxd('t-pedmenu')
...
function WarMenu.CreateMenu(id, title, subTitle, style)
	...
	menus[id] = menu
    WarMenu.SetTitleBackgroundSprite(id, 't-pedmenu', 'banner')
end
